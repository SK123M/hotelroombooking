...
<!-- Navbar -->
      <nav class="main-header navbar navbar-expand navbar-dark border border-light border-top-0  border-left-0 border-right-0 navbar-light text-sm" style="    background: url(../admin/ad.jpg);">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
